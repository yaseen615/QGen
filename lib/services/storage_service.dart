  ...
  Future<void> _addDefaultSubjects() async {
    final defaultSubjects = [
      ...
      Subject(
        id: _uuid.v4(),
        name: 'Physics (+1)',
        description: 'Class 11 Physics for NEET/JEE',
        chapters: [
      ...
      // Chemistry - Class 11 (+1)
      Subject(
        id: _uuid.v4(),
        name: 'Chemistry (+1)',
        description: 'Class 11 Chemistry for NEET/JEE',
        chapters: [
      ...
      Subject(
        id: _uuid.v4(),
        name: 'Biology (+1)',
        description: 'Class 11 Biology for NEET',
        chapters: [
      ...
      // Mathematics - Class 11 (+1)
      Subject(
        id: _uuid.v4(),
        name: 'Mathematics (+1)',
        description: 'Class 11 Mathematics for JEE',
        chapters: [
      ...
      Subject(
        id: _uuid.v4(),
        name: 'Physics (+2)',
        description: 'Class 12 Physics for NEET/JEE',
        chapters: [
          Chapter(number: 1, name: 'Electric Charges and Fields'),
          Chapter(number: 2, name: 'Electrostatic Potential and Capacitance'),
          Chapter(number: 3, name: 'Current Electricity'),
          Chapter(number: 4, name: 'Moving Charges and Magnetism'),
          Chapter(number: 5, name: 'Magnetism and Matter'),
          Chapter(number: 6, name: 'Electromagnetic Induction'),
          Chapter(number: 7, name: 'Alternating Current'),
          Chapter(number: 8, name: 'Electromagnetic Waves'),
          Chapter(number: 9, name: 'Ray Optics and Optical Instruments'),
          Chapter(number: 10, name: 'Wave Optics'),
          Chapter(number: 11, name: 'Dual Nature of Radiation and Matter'),
          Chapter(number: 12, name: 'Atoms'),
          Chapter(number: 13, name: 'Nuclei'),
          Chapter(number: 14, name: 'Semiconductor Electronics'),
        ],
        createdAt: DateTime.now(),
      ),
      ...
      Subject(
        id: _uuid.v4(),
        name: 'Chemistry (+2)',
        description: 'Class 12 Chemistry for NEET/JEE',
        chapters: [
          Chapter(number: 1, name: 'Solid State'),
          Chapter(number: 2, name: 'Solutions'),
          Chapter(number: 3, name: 'Electrochemistry'),
          Chapter(number: 4, name: 'Chemical Kinetics'),
          Chapter(number: 5, name: 'Surface Chemistry'),
          Chapter(number: 6, name: 'p-Block Elements (Group 15-18)'),
          Chapter(number: 7, name: 'd and f Block Elements'),
          Chapter(number: 8, name: 'Coordination Compounds'),
          Chapter(number: 9, name: 'Haloalkanes and Haloarenes'),
          Chapter(number: 10, name: 'Alcohols, Phenols and Ethers'),
          Chapter(number: 11, name: 'Aldehydes, Ketones and Carboxylic Acids'),
          Chapter(number: 12, name: 'Amines'),
          Chapter(number: 13, name: 'Biomolecules'),
          Chapter(number: 14, name: 'Polymers'),
          Chapter(number: 15, name: 'Chemistry in Everyday Life'),
        ],
        createdAt: DateTime.now(),
      ),
      ...
      Subject(
        id: _uuid.v4(),
        name: 'Biology (+2)',
        description: 'Class 12 Biology for NEET',
        chapters: [
          Chapter(number: 1, name: 'Reproduction in Organisms'),
          Chapter(number: 2, name: 'Sexual Reproduction in Flowering Plants'),
          Chapter(number: 3, name: 'Human Reproduction'),
          Chapter(number: 4, name: 'Reproductive Health'),
          Chapter(number: 5, name: 'Principles of Inheritance and Variation'),
          Chapter(number: 6, name: 'Molecular Basis of Inheritance'),
          Chapter(number: 7, name: 'Evolution'),
          Chapter(number: 8, name: 'Human Health and Disease'),
          Chapter(
            number: 9,
            name: 'Strategies for Enhancement in Food Production',
          ),
          Chapter(number: 10, name: 'Microbes in Human Welfare'),
          Chapter(number: 11, name: 'Biotechnology: Principles and Processes'),
          Chapter(number: 12, name: 'Biotechnology and its Applications'),
          Chapter(number: 13, name: 'Organisms and Populations'),
          Chapter(number: 14, name: 'Ecosystem'),
          Chapter(number: 15, name: 'Biodiversity and Conservation'),
          Chapter(number: 16, name: 'Environmental Issues'),
        ],
        createdAt: DateTime.now(),
      ),
      ...
      Subject(
        id: _uuid.v4(),
        name: 'Mathematics (+2)',
        description: 'Class 12 Mathematics for JEE',
        chapters: [
          Chapter(number: 1, name: 'Relations and Functions'),
          Chapter(number: 2, name: 'Inverse Trigonometric Functions'),
          Chapter(number: 3, name: 'Matrices'),
          Chapter(number: 4, name: 'Determinants'),
          Chapter(number: 5, name: 'Continuity and Differentiability'),
          Chapter(number: 6, name: 'Applications of Derivatives'),
          Chapter(number: 7, name: 'Integrals'),
          Chapter(number: 8, name: 'Applications of Integrals'),
          Chapter(number: 9, name: 'Differential Equations'),
          Chapter(number: 10, name: 'Vector Algebra'),
          Chapter(number: 11, name: 'Three Dimensional Geometry'),
          Chapter(number: 12, name: 'Linear Programming'),
          Chapter(number: 13, name: 'Probability'),
        ],
        createdAt: DateTime.now(),
      ),
    ];
